...
import { 
  Menu, LogOut, LayoutDashboard, Calendar, Users
} from "lucide-react";
...
export default function ManagerSidebar({ collapsed, setCollapsed }) {
  ...
  const links = [
    ...
    { name: "Team Members", path: "/manager/team", icon: <Users size={20} /> },
    { name: "Leave Requests", path: "/manager/leaves", icon: <Calendar size={20} /> }
  ];
